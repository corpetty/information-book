...
The pipeline this book describes is a sequence of re-encodings. The standard worry is that the inner message degrades: the content gets blurry, lossy hop after lossy hop. That happens. But it is not the main thing that happens.
