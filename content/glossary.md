...
**Three realities (Harari).** Three kinds of thing a claim can be about: *objective* (true regardless of what anyone thinks — atoms, planets), *subjective* (true only inside one mind — a pain, a dream), and *intersubjective* (true because enough people agree — money, nations, laws, brands). The pipeline treats them differently: it transmits-or-distorts objective claims, mostly skips subjective ones, and partly *creates* intersubjective ones — so for the last kind the failure mode is capture of the agreement-making process, not loss in transit. See [[case-studies-and-three-realities|Chapter 2]].
