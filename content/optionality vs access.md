...
- **The framing may understate the medium.** I blame the curve on the receiver budget, but the medium imposes its own limit too: a 280-character medium can't carry a high-optionality form even for a reader who has the budget. The honest version is probably receiver-budget and medium-capacity jointly.
