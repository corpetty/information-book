...
function seedChapters() {
  const chapters = [
    ...
    { slug: 'integration-problem',                  part: 'integration', ordinal: 9,   number: '9',  title: 'The Integration Problem',                status: 'in-workshop',     draftNote: 'note:integration-problem',            summary: 'Chapter 9 draft, promoted from skeleton to workshop. The integration problem: how complex truth moves between networks that don\'t share preconditions. Prescription has three pillars (cultivate versatile experts inside specialist communities; build curation-layer institutions that survive polarized trust; engage demand-side reform of justification-market dynamics). Engages the five operational problems substantively — bridge-node throughput (likely hard-bounded; AI capability-extender is the short-timescale relaxant); selective isolation (some disciplines need protection from integration pressure; dual structure with the bridging artifact thinner than the preserved one); bridge-node capture (consumer-key substrate, hardest to recover from; defensive design via institutional homes + auditable provenance + multiple pathways); trust-bootstrap (sub-network-first + transparent provenance + survivable-polarization design; the hardest of the five and unsolved); case studies (Wikipedia, peer-reviewed science, Stack Overflow, open-source, common-law courts — institutions decoupled-funded with consumer-key-substrate defense and survivable-polarization design demonstrate the principles work).' },
...
function seedNotes() {
  const notes = [
    ...
    { slug: 'integration-problem', file: 'integration-problem.md', subtype: 'prose', title: 'The Integration Problem', role: 'chapter-draft', summary: 'Chapter 9 draft, promoted from skeleton to workshop. Three-pillar prescription (versatile experts + curation-layer institutions + demand-side reform), substantive engagement with five operational problems (throughput, selective isolation, capture, trust-bootstrap, case studies), worked examples assessed honestly.' },
    ...
    { slug: 'the-abyss', file: 'the-abyss.md', subtype: 'prose', title: 'The Abyss', role: 'companion-essay', summary: 'Companion essay, published independently and drawn from as internal-corpus prior art. In any sufficiently complex field the possibility-space is too vast to navigate or even perceive without deep competence — you become an expert before you can see how unnavigable your own field is (The Most Unknown; Wheeler\'s lengthening shoreline; Shannon and Go game trees; Borges; Simon; Kauffman; Wolfram; du Sautoy). Two load-bearing moves for the book: expertise is a compression of the abyss (ties compression to the receiver-budget constraint), and the abyss is the experiential complement of the curse of expertise. Bounds optionality-vs-access — the artifact is a map, the abyss is the territory the map is of.' },
  ];
